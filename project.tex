...
This process is further outlined in the following table.  
\begin{center}
    \begin{tabularx}{\textwidth}{l X}
        ...
        \multirow{3}{*}{Birth-death with Birth bias (BD-B)} & (1) Pick vertex $v_i$ with probability proportional to $f_i$ \\
         ...
         &  (3) $v_i$ replaces $v_j$\\
          & \\
        \multirow{3}{*}{Death-birth with Death bias (BD-B)} & (1) Pick vertex $v_i$ with probability proportional to $f_i$ \\
         & (2) Pick vertex $v_j$ from neighbors of $v_i$ with probability $w_{ij}$ \\
         &  (3) $v_j$ replaces $v_i$\\
    \end{tabularx}
\end{center}
